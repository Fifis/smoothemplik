...
brentMin <- function(f, interval = numeric(), lower = NA_real_, upper = NA_real_, tol = 1e-8, maxiter = 500L, trace = 0L) {
    .Call(`_smoothemplik_brentMin`, f, interval, lower, upper, tol, maxiter, trace)
}

brentZero <- function(f, interval = numeric(), lower = NA_real_, upper = NA_real_, f_lower = NULL, f_upper = NULL, extendInt = "no", check_conv = FALSE, tol = 1e-8, maxiter = 500L, trace = 0L) {
    .Call(`_smoothemplik_brentZero`, f, interval, lower, upper, f_lower, f_upper, extendInt, check_conv, tol, maxiter, trace)
}
