...
ELCPP <- function(z, ct, mu, shift, lambda_init, return_weights, lower, upper, order, weight_tolerance, deriv = FALSE, thresh = 1e-16, itermax = 100L, verbose = FALSE, alpha = 0.3, beta = 0.8, backeps = 0.0) {
    .Call(`_smoothemplik_ELCPP`, z, ct, mu, shift, lambda_init, return_weights, lower, upper, order, weight_tolerance, deriv, thresh, itermax, verbose, alpha, beta, backeps)
}
