...
It is not widely known that the computer version of the Gaussian kernel effectively has finite support in most evaluations.
...
```{r}
b.ep <- bw.rot(X, kernel = "epanechnikov")  # ~0.6
print(c(object.size(kernelWeights(X, kernel = "epanechnikov", bw = b.ep)),
        object.size(kernelWeights(X, kernel = "epanechnikov", bw = b.ep, sparse = TRUE))))
```
